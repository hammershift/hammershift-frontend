...
const SelectTrigger = ({ className, children, ...props }: IProps) => (
...
const SelectScrollUpButton = ({ className, ...props }: IProps) => (
...
const SelectScrollDownButton = ({ className, ...props }: IProps) => (
...
const SelectLabel = React.forwardRef(({ className, ...props }: IProps, ref) => (
...
const SelectItem = ({ className, children, ...props }: IProps) => (
...
const SelectSeparator = ({ className, ...props }: IProps) => (
