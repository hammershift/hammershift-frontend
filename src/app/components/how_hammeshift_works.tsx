                    ...
                    <div className='tw-flex tw-flex-col md:tw-flex-row'>
                        <div className='tw-flex tw-flex-wrap'>
                            <div className='tw-flex tw-justify-between tw-w-full tw-min-w-[280px] xl:tw-w-[300px]  tw-pr-0 md:tw-pr-4 tw-py-4 md:tw-py-8'>
                                ...
                                <Image src={articleImageOne} width={80} height={80} alt='car' className='tw-w-20 tw-h-20 tw-object-cover tw-ml-6' />
                            </div>
                            ...
                            <div className='tw-flex  tw-justify-between tw-w-full tw-min-w-[280px] xl:tw-w-[300px] tw-pr-0 md:tw-pr-4 tw-py-4 md:tw-py-8'>
                                ...
                                <Image src={articleImageTwo} width={80} height={80} alt='car' className='tw-w-20 tw-h-20 tw-object-cover tw-ml-6' />
                            </div>
                        </div>
                        ...
                        <div className='tw-flex tw-flex-wrap'>
                            <div className='tw-flex  tw-justify-between tw-w-full tw-min-w-[280px] xl:tw-w-[300px] tw-pr-0 md:tw-pr-4 tw-py-4 md:tw-py-8 '>
                                ...
                                <Image src={articleImageThree} width={80} height={80} alt='car' className='tw-w-20 tw-h-20 tw-object-cover tw-ml-6' />
                            </div>
                            <hr style={{ borderColor: 'black', opacity: "10%" }} className='tw-mx-0 md:tw-mx-4 tw-my-4 md:tw-my-0' />
                            <div className='tw-flex  tw-justify-between tw-w-full tw-min-w-[280px] xl:tw-w-[300px] tw-pr-0 md:tw-pr-4 tw-py-4 md:tw-py-8 '>
                                <div>
                                ...
                                <Image src={articleImageFour} width={80} height={80} alt='car' className='tw-w-20 tw-h-20 tw-object-cover tw-ml-6' />
                            </div>
                        </div>
