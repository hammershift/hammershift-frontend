...
const Subscribe = () => {
    return (
        <div>
            <div className='tw-relative tw-text-[#0F1923] tw-bg-[#F2CA16] tw-h-auto tw-flex  tw-items-center tw-w-screen tw-mt-[-1px] tw-overflow-hidden'>
                <div className='tw-relative tw-mt-96 md:tw-mt-0 tw-px-4 md:tw-px-16 tw-w-screen 2xl:tw-w-[1440px] tw-py-32 tw-z-50 '>
                ...
                <div className='tw-overflow-hidden'>
                    <div className='tw-absolute tw-top-0 tw-right-0 tw-w-full md:tw-w-auto tw-h-[424px] md:tw-h-auto'>
                        <div style={{
                            position: 'absolute',
                            height: 'auto',
                            width: 'auto',
                        ...
                        <Image src={CarDesign} width={997} height={644} alt='design' className='tw-w-auto tw-h-auto tw-z-[-1] tw-mt-[1px] tw-ml-[20px]' />
                    </div>
                </div>
            </div >
        </div>
