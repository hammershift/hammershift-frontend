...
export const HowItWorks = () => {
  const steps = [
    ...
    },
    {
      ...
      description: "Analyze the details and predict the final hammer price",
    },
    {
      icon: <Trophy />,
      ...
      <div className="mx-auto mb-8 max-w-3xl rounded-md border border-orange-800/30 bg-orange-900/20 p-4">
        <div className="flex gap-3">
          ...
          <p className="text-left text-sm text-orange-400">
            ...
            entertainment purposes. While we offer paid games with real prizes,
            these involve financial risk. Users should be aware that all
            predictions are speculative in nature and we make no guarantees
            regarding outcomes. Never participate with money you cannot afford
            to lose, and remember that all activities on our platform are
