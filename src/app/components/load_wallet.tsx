  ...
  return (
    <div className='max-md:tw-hidden'>
      {!session ? null : pathname === '/my_wallet' ? null : isLoading ? (
        ...
        <div className='tw-fixed tw-bottom-5 tw-right-16 tw-px-6 max-md:tw-hidden lg:tw-w-1/3 xl:tw-w-1/5'>
          {isWalletDepositEnabled ? (
            <div className='hover:tw-cursor-pointer' onClick={() => setIsPaymentModalOpen(true)}>
              <div className='tw-bg-[#49C74233] tw-backdrop-blur-md tw-w-full tw-px-6 tw-py-4 tw-rounded tw-flex tw-items-center tw-gap-6'>
