...
const Tournaments = () => {
  ...
  return (
    <div className="tw-py-8 sm:tw-py-16">
      ...
      <section className="tw-flex tw-flex-col tw-justify-center tw-items-center tw-w-auto sm:tw-flex-row sm:tw-w-full tw-gap-4 sm:tw-gap-8 tw-mt-8 tw-overflow-scroll">
        {tournamentsData &&
