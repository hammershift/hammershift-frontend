  ...
  return (
    <div>
      <div className="page-container gap-5">
        ...
        <div className="section-container">
          <h3 className="text-xl py-2 font-bold">Definitions</h3>
        ...
        <div className="section-container">
          <h3 className="text-xl py-2 font-bold">User Accounts</h3>
          <p className="px-2">
        ...
        <div className="section-container">
          <h3 className="text-xl py-2 font-bold">Termination</h3>
          <p className="px-2">
        ...
        <div className="section-container">
          <h3 className="text-xl py-2 font-bold">Governing Law</h3>
          <p className="px-2">
