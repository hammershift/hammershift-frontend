    ...
    <div className='tw-flex tw-flex-col tw-items-center'>
      ...
      <div className='tw-pb-16 '>
        <section className='tw-w-screen tw-px-4 md:tw-px-16 2xl:tw-w-[1440px] tw-overflow-hidden'>
          <div className=' tw-w-full 2xl:tw-w-[1312px] '>{loading ? <AuctionsList listing={listing} /> : <div className='tw-text-center'>Loading... </div>}</div>
        </section>
        <div className='tw-w-screen tw-px-4 md:tw-px-16 2xl:tw-w-[1440px] '>
          <div className='tw-text-[18px] tw-opacity-50 tw-text-center tw-mt-16 tw-mb-4'>{`Showing ${listing.length > 0 ? listing?.length : '0'} of ${
            totalAuctions || '0'
          } auctions`}</div>
          <button
