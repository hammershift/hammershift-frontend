    ...
    <div className="page-container tw-pt-16 tw-gap-16">
      <div className="section-container tw-flex tw-flex-col sm:tw-flex-row tw-justify-between tw-pb-8 tw-gap-6">
        ...
        <div className="tw-w-full md:tw-w-[528px] tw-opacity-80 tw-self-end">
          Esse Lorem velit sunt magna duis qui cupidatat nostrud id nulla mollit
          ea nisi. Non elit exercitation tempor veniam Lorem. Officia amet ea
          labore consequat irure excepteur labore reprehenderit dolore.
        </div>
      </div>
      <Image
        src={AboutImage}
      ...
      <div className="section-container tw-pt-8 tw-flex tw-flex-col sm:tw-flex-row tw-justify-between tw-gap-6">
        ...
        <div className=" tw-text-2xl tw-max-w-[752px]">
          <div className="tw-font-bold ">
            ...
            <span className="tw-text-[#F2CA16]">Rick Deacon</span> and{" "}
            <span className="tw-text-[#F2CA16]">Ryan Turri</span>, Hammershift
            is not just a company; {"it's"} a vibrant community for car
            enthusiasts.
          </div>
          <br />
          <div>
            We foster a space where individuals can engage with the thrill and
            prestige of car auctions, yet without the pressure of committing
            substantial finances.Our team leverages a deep - rooted passion for
            automobiles and an innovative mindset to bring an inclusive,
            exciting, and affordable experience to every car lover out there.
          </div>
        </div>
      </div>
      ...
      <div className="section-container tw-pt-8 tw-flex tw-flex-col sm:tw-flex-row tw-justify-between tw-gap-6">
        ...
        <div className=" tw-text-2xl tw-max-w-[752px]">
          <div className="tw-font-bold">
            We believe in empowering individuals to be part of the dynamic world
            of car auctions, regardless of their budget.
          </div>
          <br />
          <div>
            By blending technology, industry insights, and an unwavering
            dedication to community, we make the inaccessible accessible, and
            the extraordinary ordinary.
          </div>
          <br />
          <div>
            Our vision is to create a platform that democratizes the car auction
            experience, fostering an inclusive community that thrives on shared
            passion and collective growth.
          </div>
          <br />
          <div>
            With Hammershift, every car enthusiast can enjoy the exhilaration of
            auctions and the sheer joy of the automobile world.
          </div>
          <br />
        </div>
      </div>
