            ...
            <div className="max-w-3xl mx-auto">
                ...
                <Card className="bg-[#16181f] border-white/[0.08] mb-8">
                    <div className="p-6">
                        ...
                        <Accordion type="single" collapsible className="w-full">
                            <AccordionItem value="mode-1" className="border-white/[0.08]">
                            ...
                            <AccordionItem value="mode-2" className="border-white/[0.08]">
                            ...
                            <AccordionItem value="mode-3" className="border-white/[0.08]">
                ...
                <Card className="bg-[#16181f] border-white/[0.08] mb-8">
                    <div className="p-6">
                        ...
                        <Accordion type="single" collapsible className="w-full">
                            <AccordionItem value="account-1" className="border-white/[0.08]">
                            ...
                            <AccordionItem value="account-2" className="border-white/[0.08]">
                            ...
                            <AccordionItem value="account-3" className="border-white/[0.08]">
