        ...
        try {
            ...
            if (!response.ok) {
                ...
                if (data.message === 'Username already used') {
                    setMessage({ type: "error", text: "Username is already in use. Try a different one." });
                }
                setIsLoading(false);
                return;
            }
        ...
        <div className="container mx-auto px-4 py-12">
            ...
            <Tabs defaultValue="profile" className="w-full">
                <TabsList className="bg-[#1E2A36] mb-6">
                    <TabsTrigger value="profile" className="flex items-center gap-2 data-[state=active]:bg-[#F2CA16] data-[state=active]:text-[#0C1924]">
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            disabled
                                            className="bg-[#1E2A36] border-[#1E2A36] opacity-70"
                                        />
