...
const CreateAccount = () => {
    ...
    // GOOGLE SIGNIN
    useEffect(() => {
        const emailExistsParam = new URLSearchParams(
                    ...
                    {createAccountPage === "page three" && (
                        ...
                        <div className="tw-w-screen md:tw-w-[640px] tw-px-6 tw-flex tw-flex-col tw-gap-8 tw-pt-6">
                            <div>
                                ...
                                <div>
                                    We need your identification to lorem ipsum
                                    dolor sit amet. Data is processed securely.
                                </div>
                            </div>
