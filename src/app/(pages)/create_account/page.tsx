...
const CreateAccount = () => {
  ...
  // creating an account handler (page one)
  ...
  // another handler for setting up the profile (page two)
      ...
      {createAccountPage === 'page two' && (
        ...
        <div className='tw-w-screen md:tw-w-[640px] tw-px-6 tw-flex tw-flex-col tw-gap-8 tw-pt-6'>
          ...
          <div className='tw-flex tw-flex-col tw-gap-5'>
            ...
            <div className='tw-flex tw-flex-col tw-gap-2'>
              <button className='btn-yellow' onClick={() => setCreateAccountPage('page three')}>
