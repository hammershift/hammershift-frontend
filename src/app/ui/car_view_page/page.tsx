...
export const initialState = {
  ...
  images_list: [
    {
      placing: 1,
      src: "https://bringatrailer.com/wp-content/uploads/2023/07/5D5A2956-17001-scaled.jpg",
    },
    {
      placing: 2,
      src: "https://bringatrailer.com/wp-content/uploads/2023/07/5D5A2945-17027-scaled.jpg",
    },
    {
      placing: 3,
      src: "https://bringatrailer.com/wp-content/uploads/2023/07/5D5A2894-17370-scaled.jpg",
    },
    {
      placing: 4,
      src: "https://bringatrailer.com/wp-content/uploads/2023/07/5D5A2897-17394-scaled.jpg",
    },
    {
      placing: 5,
      src: "https://bringatrailer.com/wp-content/uploads/2023/07/1974_bmw_2002-turbo_5D5A5368-18936-scaled.jpg",
    },
  ],
  listing_details: ["", ""],
};
  ...
  return (
    <div className="tw-flex">
      ...
      <button
        ...
        onClick={() => router.push("/wager_page")}
      >
        PLACE MY WAGER
      </button>
    </div>
...
const TitleContent: React.FC<TitleContainerProps> = ({
  year,
  make,
  model,
  current_bid,
