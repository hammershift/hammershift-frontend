        ...
        <div className='tw-w-screen md:tw-w-[640px] tw-px-6 tw-h-[505px] tw-flex tw-flex-col tw-gap-8 tw-pt-6'>
          ...
          <div className='tw-flex tw-flex-col tw-gap-6 tw-text-sm'>
            ...
            <div className='tw-flex tw-flex-col tw-gap-2'>
              ...
              <input className='tw-py-2.5 tw-px-3 tw-bg-[#172431]' placeholder='********' value={password} onChange={(e) => setPassword(e.target.value)} />
            </div>
          </div>
          ...
          <button className='btn-yellow' onClick={handleSignIn}>
            Sign In
          </button>
