    ...
    <div className=" section-container tw-relative tw-pt-8 md:tw-pt-16 tw-h-[344px] tw-overflow-hidden">
      <div className="carousel-container tw-relative tw-w-full tw-h-[280px] tw-overflow-hidden">
        <div
          ...
          style={{ transform: `translate(${sliderTransform}%)`, width: "500%" }}
        >
          <SlideOne />
                ...
                <li key={slide.id}>
                  <button onClick={() => setSlidertransform(slide.transform)}>
                    <div
                      ...
                      style={{
                        opacity: `${
                          sliderTransform === slide.transform ? "100%" : "20%"
                        }`,
                      }}
                    ></div>
                  </button>
        ...
        <div className="right-container tw-grid tw-grid-cols-1 sm:tw-grid-cols-2 tw-gap-16 xl:tw-gap-16 tw-w-auto tw-h-auto">
          ...
          <div className="tw-relative">
            ...
            <div className="tw-absolute tw-top-[26px] tw-h-[362px] tw-z-[-1]">
              ...
              <button className="btn-green tw-absolute tw-bottom-[-20px] tw-right-[16px]">
                Wager on Team B
              </button>
            </div>
          </div>
          ...
          <div className="tw-relative tw-pb-8 sm:tw-pb-0">
            ...
            <div className="tw-absolute tw-top-[26px] tw-h-[362px] tw-z-[-1]">
              ...
              <button className="btn-blue tw-absolute tw-bottom-[-20px] tw-right-[16px]">
                Wager on Team B
              </button>
            </div>
          </div>
  ...
  return (
    <div className="tw-w-screen 2xl:tw-w-[1440px] tw-mt-[-1px] tw-flex tw-justify-center">
      <Image
        ...
        height={356}
        alt="pattern"
        className="tw-absolute tw-z-[-1] tw-w-screen tw-h-auto tw-mr-1 tw-object-cover"
      />
