        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
            <div className="text-center">
              ...
              <div className="text-3xl font-bold text-[#F2CA16]">💰??</div>
              <div className="text-gray-300">Prize Money Awarded</div>
            </div>
            <div className="text-center">
              <Users className="mx-auto mb-2 h-8 w-8 text-[#F2CA16]" />
              <div className="text-3xl font-bold text-[#F2CA16]">12,400+</div>
              <div className="text-gray-300">Active Players</div>
            </div>
            <div className="text-center">
              <DollarSign className="mx-auto mb-2 h-8 w-8 text-[#F2CA16]" />
              <div className="text-3xl font-bold text-[#F2CA16]">💰??</div>
              <div className="text-gray-300">Avg. Tournament Prize</div>
            </div>
            <div className="text-center">
              <Timer className="mx-auto mb-2 h-8 w-8 text-[#F2CA16]" />
              <div className="text-3xl font-bold text-[#F2CA16]">97%</div>
              <div className="text-gray-300">Player Satisfaction</div>
            </div>
          </div>
          <p className="mt-4 text-center text-sm text-gray-300">
            Statistics are subject to change based on player participation.
          </p>
        </div>
      </section>
      {/* Leaderboard */}
