...
const Homepage = () => {
    ...
    const [isNewEraWageringVisible, setIsNewEraWageringVisible] =
        useState(false);
    ...
    return (
        <div className="2xl:tw-flex tw-flex-col tw-items-center tw-justify-center">
            ...
            <div className="tw-w-full" ref={newEraWageringRef}>
            ...
            <div ref={mostExpensiveCarsRef}>
                {isMostExpensiveCarsVisible ? (
                    <DynamicMostExpensiveCars />
                ) : null}
            </div>
            <div ref={mostBidsRef}>
            ...
            <div className="tw-w-full" ref={howHammershiftWorksRef}>
                {isHowHammershiftWorksVisible ? (
                    <DynamicHowHammerShiftWorks />
                ) : null}
            </div>
