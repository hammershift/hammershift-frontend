        ...
        <div className='tw-bg-black/80 tw-w-screen tw-h-auto sm:tw-h-screen tw-flex tw-justify-center tw-items-center tw-absolute tw-top-0 tw-left-0'>
            <div className='tw-relative tw-bg-[#0F1923] tw-w-full sm:tw-w-[864px] tw-h-full sm:tw-h-[900px] tw-pt-8'>
                    ...
                    <div className='tw-flex tw-flex-col tw-gap-4'>
                        {
                            tournamentWagerPageData.map((data) =>
                                <div key={data.img}>
                                    <TournamentWagerPageCard img={data.img} name={data.name} current_bid={data.current_bid} time_left={data.time_left} />
                ...
                <div className='tw-fixed tw-bottom-0 tw-left-0 sm:tw-static tw-items-center tw-flex tw-justify-between tw-h-[80px] tw-w-full tw-p-6 tw-bg-[#172431] tw-mt-6 tw-z-20'>
                    <button className='tw-hidden sm:tw-block'>CANCEL</button>
                    <button className='btn-yellow tw-h-[48px] tw-w-full sm:tw-w-[224px]'>BUY-IN FOR $100</button>
                </div>
            </div>
    ...
    return (
        <div className='tw-text-sm tw-flex tw-flex-col sm:tw-flex-row sm:tw-justify-between tw-items-center tw-gap-4'>
            <div className='tw-flex tw-gap-4'>
                ...
                <div className='tw-flex tw-flex-col tw-justify-center'>
                    ...
                    <div className='tw-flex tw-gap-2 tw-items-center'>
                        <Image src={Dollar} width={14} height={14} alt='sedan' className='tw-w-[14px] tw-h-[14px]' />
                        <span className='tw-opacity-80'>Current Bid:</span>
                        <span className='tw-font-bold tw-text-[#49C742]'>{current_bid}</span>
                    </div>
                    <div className='tw-flex tw-gap-2 tw-items-center'>
            ...
            <div className='tw-relative tw-flex tw-items-center tw-rounded tw-w-full sm:tw-w-[224px]'>
                <div className='tw-w-lg tw-h-auto tw-top-[50%] tw--translate-y-[50%] tw-left-3 tw-absolute tw-text-gray-500 tw-z-10' >$</div>
