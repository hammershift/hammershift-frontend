  ...
  return (
    <div>
      <Image
        ...
        height={219}
        alt="ferrari"
        className="tw-w-[200px] sm:tw-w-[416px] tw-h-[147px] sm:tw-h-[219px]  tw-object-cover"
      />
      ...
      <p className="tw-h-[60px] sm:tw-h-[72px] tw-w-full tw-text-ellipsis tw-overflow-hidden tw-text-[14px] sm:tw-text-[16px]">
        This 1981 Ferrari 512 BB is one of 929 carbureted examples produced
        between 1976 and 1981, and it was imported to the US in July 1981. The
        car was registered in Oregon through the late 2000s and was acquired by
        the selling dealer in 2022, reportedly from its second owner. It has
        been refinished in silver over black leather
      </p>
      ...
      <div className="tw-flex">
        ...
        />
        <div className="tw-px-2 tw-hidden sm:tw-block">Current Bid:</div>
        <div className="tw-text-[#C2451E] tw-font-bold">
          {cardData.current_bid}
        </div>
      </div>
